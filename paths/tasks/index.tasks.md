...
| --------------------------------------------------------------------------------------------------------------------------- | ------ | --------------------------------------------------------------------------------------------------------------------------------------- |
| [Shortlist the next lab demos](./2026-07-21-shortlist-next-lab-demos.task.md)                                               | Andrew | Review the shortlist, lock one post-submission pick (default: graduate Campus Constellation), then open or park the build               |
