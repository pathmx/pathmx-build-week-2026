...
| --------------------------------------------------------------------------------------------------------------------------- | ------ | --------------------------------------------------------------------------------------------------------------------------------------- |
| [Deploy the static site to Cloudflare](./2026-07-21-deploy-static-site-to-cloudflare.task.md)                              | Mark   | Keep deployment and judge reproduction on latest until the 7:30 PM submission freeze                                                   |
...
| [Shortlist the next lab demos](./2026-07-21-shortlist-next-lab-demos.task.md)                                               | Andrew | Second-wave options parked; after the in-flight trio merges, claim negotiation rehearsal or debugging dojo                              |
