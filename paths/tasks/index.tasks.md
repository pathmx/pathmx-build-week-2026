...
| [Build a YouTube watch-and-recall lab](./2026-07-21-build-youtube-watch-recall-lab.task.md)                                 | Andrew | Implement the provided-transcript MVP under `paths/labs/youtube-watch-recall/`, link the hub, and verify build/route/Play               |
| [Graduate Campus Constellation into Labs](./2026-07-21-graduate-campus-constellation-labs.task.md)                          | Andrew | Run the readiness pass; graduate into Labs if clear, otherwise record blockers                                                          |
