...
| ---- | ----- | --------- |
| —    | —     | Board cleared at the July 21 submission freeze. |
...
| Task                                                                                                          | Owner      | Result                                                                                                                                                                 |
| ------------------------------------------------------------------------------------------------------------- | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Deploy the static site to Cloudflare](./2026-07-21-deploy-static-site-to-cloudflare.task.md)                 | Mark       | Player-embedded static bundle redeployed to `build-week.pathmx.net` on PathMX 0.1.27 (426 files / 263 routes) at freeze                                                |
| [Prepare the learner starter and submission](./2026-07-15-prepare-learner-starter-and-submission.task.md)     | Mark       | Starter, skills, hosted bootstrap, eval report, and public site ready; private Devpost fields stay outside the repo                                                    |
| [Produce the three-minute submission video](./2026-07-20-produce-submission-video.task.md)                     | Mark       | Submission walkthrough deck is the hub Start Here Path; YouTube URL stays in the private Devpost checklist                                                             |
| [Update the PathMX skills package](./2026-07-20-update-pathmx-skills.task.md)                                  | Tram       | `/learn` · `/teach` · `/pathmx` shipped byte-identical across canonical, Starter, and Build Week; Desktop retest deferred                                              |
| [Build a YouTube watch-and-recall lab](./2026-07-21-build-youtube-watch-recall-lab.task.md)                    | Andrew     | MVP at `/labs/youtube-watch-recall` with provided transcript and five timestamped questions; live response pass skipped                                                |
| [Shortlist the next lab demos](./2026-07-21-shortlist-next-lab-demos.task.md)                                  | Andrew     | First-wave trio integrated; second-wave options parked in Andrew's shortlist notes                                                                                     |
| [Build Relationship Garden MVP lab](./2026-07-21-build-relationship-garden-mvp-lab.task.md)                   | Andrew     | Playable garden MVP verified; stewardship approval and change-log publish deferred                                                                                     |
| [Build a My Greenville coffee Path](./2026-07-21-build-my-greenville-coffee-path.task.md)                     | Andrew     | Linked five-place outline at `/labs/my-greenville`; personal atlas interaction deferred                                                                                |
| [Explore reference labs and test the authoring skill](./2026-07-15-explore-reference-labs-and-test-authoring-skill.task.md) | Andrew | Campaign Forge kept as working third showcase; remaining field-guide keyboard pass deferred                                                                            |
| [Feature labs index demos](./2026-07-21-feature-labs-index-demos.task.md)                                      | Mark       | Labs hub now leads with Chess / Kepler / Campus feature cards using the shared landing presentation; All demos list kept as chip-styled links                           |
| [Publish the PathMX Core progress log](./2026-07-21-publish-pathmx-core-progress-log.task.md)                 | Mark       | Final July 13–21 Core audit documented through verified 0.1.26, including releases, architecture, UX, performance, onboarding, and remaining limits                    |
| [Strip lab demo ceremony](./2026-07-21-strip-lab-demo-ceremony.task.md)                                       | Mark       | Removed What-to-copy / Minimum PathMX / author-handoff prose; demos now open as experiences                                                                            |
| [Bookshelf title tip on hover and Play](./2026-07-21-bookshelf-title-tip.task.md)                             | Mark       | Title tip shows on hover and active Play Beat; shelf scroll padding keeps tips visible without JS                                                                      |
| [Retune Bookshelf demo titles for Build Week](./2026-07-21-retune-bookshelf-demo-titles.task.md)              | Mark       | Five shelves now use sci-fi, alignment, and computing-culture titles; all 30 Open Library covers verified in Player                                                    |
| [Add team LinkedIn links to hub cards](./2026-07-21-add-team-linkedin-links.task.md)                          | Mark       | Hub team cards now include compact LinkedIn chips for Mark, Tram, and Andrew                                                                                           |
| [Add team avatars to hub cards](./2026-07-21-add-team-avatars-to-hub.task.md)                                 | Mark       | Hub team cards now show Mark, Tram, and Andrew portraits from `paths/assets/`                                                                                          |
| [Graduate Campus Constellation into Labs](./2026-07-21-graduate-campus-constellation-labs.task.md)            | Andrew     | Path, components, and scoped CSS moved into `paths/labs/campus-constellation/`, prefilled fixtures cleared, Labs hub linked, research entry rewritten as a pointer stub, build + Play verified |
| [Build a research bench lab](./2026-07-21-build-research-bench-lab.task.md)                                   | Andrew     | Playable claim → citation → confidence → next-question bench landed under `paths/labs/research-bench/`, linked from the Labs hub, and verified via focused/root builds and route lookup |
| [Capture Andrew demo strategy notes on main](./2026-07-17-andrew-demo-strategy-notes.task.md)                | Andrew     | Relationship Garden outline + agent implementation plan landed under `paths/andrew/` and linked from research                                                          |
| [Add project feature cards](./2026-07-21-add-project-feature-cards.task.md)                                   | Mark       | Home cards now lead to the hosted bootstrap, technical eval report, and playable labs; the layout demo keeps fictional examples       |
