...
| --------------------------------------------------------------------------------------------------------------------------- | ------ | --------------------------------------------------------------------------------------------------------------------------------------- |
| [Deploy the static site to Cloudflare](./2026-07-21-deploy-static-site-to-cloudflare.task.md)                              | Mark   | Redeploy and verify the corrected embedded Player, then pin the accepted release at the 7:30 PM freeze                                |
| [Build a YouTube watch-and-recall lab](./2026-07-21-build-youtube-watch-recall-lab.task.md)                                 | Andrew | MVP authored, linked, and built (`/labs/youtube-watch-recall`); Andrew runs live Player submission pass before closing                  |
| [Shortlist the next lab demos](./2026-07-21-shortlist-next-lab-demos.task.md)                                               | Andrew | First-wave trio integrated; claim negotiation rehearsal next, or debugging dojo as the STEM alternate                                   |
| [Build The Greenville Coffee Scene](./2026-07-21-build-my-greenville-coffee-path.task.md)                                  | Andrew | Play the linked outline, review its voice, and choose the scene anchors before building the field-guide interaction                    |
| [Produce the three-minute submission video](./2026-07-20-produce-submission-video.task.md)                                  | Mark   | Rehearse to 2:45–2:50 with the Relationship Garden cut, verify the live learner loop, then record and verify YouTube by 7 PM            |
...
| [Explore reference labs and test the authoring skill](./2026-07-15-explore-reference-labs-and-test-authoring-skill.task.md) | Andrew | After submission, finish the independent Campaign Forge focus and arrow-key field-guide pass                                            |
...
| Task                                                                                                          | Owner      | Result                                                                                                                                                                 |
| ------------------------------------------------------------------------------------------------------------- | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Prioritize Chess and Kepler labs](./2026-07-21-prioritize-chess-kepler-labs.task.md)                        | Andrew     | Labs hub now begins Chess, Chess Opening Lesson, and Kepler Orbit; link preservation, scratch build, and exact-route checks passed      |
| [Build Relationship Garden MVP lab](./2026-07-21-build-relationship-garden-mvp-lab.task.md)                  | Andrew     | Local-first personal CRM with transparent weekly review, context-safe touch logging, resolved loops, and a precise Codex handoff; locked as the third showcase          |
