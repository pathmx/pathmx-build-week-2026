...
| [Build Relationship Garden MVP lab](./2026-07-21-build-relationship-garden-mvp-lab.task.md)                                | Andrew | Review the live stewardship tone and Priya flow, then approve the change-log and publish pass                                          |
| [Build a My Greenville coffee Path](./2026-07-21-build-my-greenville-coffee-path.task.md)                                  | Andrew | Play the linked outline, review its voice, and choose the personal anchors before building the atlas interaction                       |
