...
| --- | --- | --- | --- | --- |
| [Capture Andrew demo strategy notes off main](./2026-07-17-andrew-demo-strategy-notes.task.md) | Andrew | Mark | Hand Reputation Garden implementation plan to an implementing agent | July 21 |
