...
related:
  ...
  - ./2026-07-21-relationship-garden-outline.notes.md
  - ../labs/index.path.md
...
The Labs hub already proves several PathMX learning shapes:

| Shape | Demo already in hub |
| --- | --- |
| Practice arena | Chess opening lesson, practice interview |
| Studio / workshop | Campaign Forge |
| Instrument / explore | Kepler, Dialectic Spiral, 3D globe, Focus beats |
| Life-memory instrument | Relationship Garden (MVP under review) |
...
## Submission Day Constraint

Do **not** start a new hero demo before the 7 PM video / submission cutoff.

Current showcase triangle in the walkthrough:

1. **Practice** — Chess opening lesson
2. **Explore** — Kepler
3. **Create** — Campaign Forge (still the open lock-or-replace decision)

Relationship Garden and My Greenville strengthen the post-video story and the
Labs hub. They should not replace the cold-start learner loop in the recording
unless Mark explicitly swaps the third cut.
...
- **Why:** Same practice-arena shape as the interview lab, without betting on
  ...
  roommate talk all fit.
- **Demo beat:** Pick stakes → draft opening line → submit attempt → rubric
  marks one weak spot → Codex adapts the next Beat from Source evidence.
...
- **Demo beat:** Week-1 map → one relationship to open → one skill gap → one
  logged check-in that changes tomorrow's Block.
- **Cost:** Mostly authoring; light interaction.
...
## Pairings That Tell A Stronger Product Story
...
1. Does it leave durable Markdown evidence the agent can read tomorrow?
2. Is there one gorgeous Player moment that cannot be a chat bubble?
3. Can a reviewer finish a useful arc in under ten minutes?
4. Does it expand a missing shape, or only duplicate Chess / Kepler / Forge?
5. Can it stay local-first without fragile live services?

If three answers are weak, keep it as research—not a Labs hub demo.
