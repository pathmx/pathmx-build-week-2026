...
# Relationship Garden + Parallel Lives Outline
...
Relationship Garden: tend a life-memory instrument.
...
## Relationship Garden (playable map)
...
Relationship Garden is the **ongoing studio** that accumulates people over time.
...
1. Begin: `Help me tend my Relationship Garden for [bed]. Suggest one human I should contact, using only my local people files.`
...
- Should “Relationship Garden” stay, or does another stewardship name fit better?
...
- [Relationship Garden implementation plan](./2026-07-21-relationship-garden-implementation.plan.md)

Naming for MVP is locked there as **Relationship Garden** (stewardship copy
in UI).
